        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-16 items-center">
            <div className="space-y-6 text-lg font-bold text-muted-foreground">
              <p>
                Hello! My Name is Nishant Baiga I'm a software engineer who
                never truly stopped playing with LEGO. I believe that great
                software is built just like a great LEGO set: with a clear
                vision, strong foundations, and attention to every single brick.
              </p>
              <p>
              ...
              <div className="flex flex-wrap gap-4 pt-4">
                <div className="p-4 bg-muted lego-border lego-shadow-sm relative">
                  <h4 className="font-black uppercase text-[#E3000B]">
                    1+ Years
                  </h4>
                ...
                <div className="p-4 bg-muted lego-border lego-shadow-sm">
                  <h4 className="font-black uppercase text-[#0055BF]">
                    10+ Projects
                  </h4>
